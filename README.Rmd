...
The goal of `boxoffice()` is to scrape movie data to get information about daily box office results of movies. It scrapes the webpages of either [http://www.boxofficemojo.com](http://www.boxofficemojo.com) or [https://www.the-numbers.com/](https://www.the-numbers.com/) for this information. The data it returns are the following:
