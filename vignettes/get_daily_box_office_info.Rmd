...
The `boxoffice()` function scrapes information about daily box office results of movies. It scrapes the webpages [https://www.the-numbers.com/](https://www.the-numbers.com/) for this information. The data it returns are the following:
